...
<head>
    ...
    <title>Chanel Modern White Shoulder Bag - Tiangge Inc.</title>
...
<nav class="navbar navbar-light navbar-expand-md py-3" style="font-size: 18px;font-family: Poppins, sans-serif;">
    ...
    <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="assets/img/chanel/product2.jpg" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="assets/img/chanel/product2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/chanel/chanel2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/chanel/chanel3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/chanel/chanel4.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    <p>Home/Women</p>
                    <h1>Chanel Modern White Shoulder Bag</h1>
                    <h4>Php 300.00</h4>
                    <select>
                    ...
                    <br>
                    <p>This Chanel Shoulder Bag features a pristine white exterior crafted from premium, durable materials, 
                        ensuring both style and longevity. The sleek and streamlined silhouette exudes sophistication, 
                        making it the perfect companion for both casual outings and formal occasions.
                    </p>
                </div>
            </div>
        </div>
