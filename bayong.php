...
<nav class="navbar navbar-light navbar-expand-md py-3" style="font-size: 18px;font-family: Poppins, sans-serif;">
    ...
    <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="assets/img/bayong/main.png" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="assets/img/bayong/main.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/bayong/1.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/bayong/2.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/bayong/3.png" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <h1>Baybayin Modern Painted Bayong</h1>
                    <h4>Php 279.00</h4>
                    <select>
                    ...
                    <br>
                    <p>This handcrafted bayong features stunning modern painted designs inspired by the traditional bayong, 
                        celebrating Filipino heritage with a creative twist. Made from eco-friendly materials, it is both durable and stylish, 
                        perfect for shopping trips, beach outings, or casual day-to-day use.
                    </p>
                </div>
            </div>
        </div>
