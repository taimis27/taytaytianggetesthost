...
<head>
    ...
    <title>NICE White Sneakers Exclusive Edition - Tiangge Inc.</title>
...
<nav class="navbar navbar-light navbar-expand-md py-3" style="font-size: 18px;font-family: Poppins, sans-serif;">
    ...
    <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="assets/img/whsneakers/gallery1.webp" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="assets/img/whsneakers/gallery1.webp" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/whsneakers/gallery2.webp" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/whsneakers/gallery3.webp" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/whsneakers/gallery4.webp" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    <p>Home/Men</p>
                    <h1>NICE White Sneakers Exclusive Edition</h1>
                    <h4>Php 279.00</h4>
                    <select>
                    ...
                    <br>
                    <p>Step into a world of timeless elegance as you lace up these NICE White Sneakers Exclusive Edition. 
                    The clean and sleek design effortlessly blends with any outfit, making it the ultimate versatile companion 
                    for both casual and athleisure wear.
                    </p>
                </div>
            </div>
        </div>
