...
<head>
    ...
    <title>Taytay Footwear Leather Sandals - Tiangge Inc.</title>
...
<nav class="navbar navbar-light navbar-expand-md py-3" style="font-size: 18px;font-family: Poppins, sans-serif;">
    ...
    <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="assets/img/sandals/main.jpg" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="assets/img/sandals/main.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/sandals/1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/sandals/2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/sandals/3.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    ...
                    <h1>Taytay Footwear Leather Sandals</h1>
                    <h4>Php 350.00</h4>
                    <select>
                    ...
                    <br>
                    <p>The ergonomic design provides excellent support for all-day wear, while the adjustable straps ensure a perfect fit. 
                        Whether you're strolling through the city or enjoying a beach getaway, the Taytay Footwear Leather Sandals 
                        will keep you stylish and comfortable every step of the way.
                    </p>
                </div>
            </div>
        </div>
