        ...
        <div class="container">
            ...
            <div class="row justify-content-center" style="margin-right: 0;font-family: Poppins, sans-serif;font-size: 41px;">
                <div class="col-md-6 col-xl-3 col-xxl-3" style="width: 275px;margin: 15px;padding: 0px;height: 275px;margin-left: 0px;margin-right: 0px;">
                    ...
                    <button class="btn btn-primary" type="button" style="width: 275px;height: 60px;margin-top: 5px;margin-bottom: 5px;font-size: 20px;text-align: left;background: #ffffff;border-width: 2px;border-color: #2d3693;color: #2d3693;padding-top: 12px;padding-bottom: 12px;"herf="seller-dashboard-products.php">Products</button>
                    ...
                    <a class="btn btn-primary active" role="button" style="width: 275px;height: 60px;margin-top: 5px;margin-bottom: 5px;font-size: 20px;text-align: left;background: #2d3693;border-width: 2px;border-color: #2d3693;color: #ffffff;padding-top: 12px;padding-bottom: 12px;" href="seller-dashboard-account.php"><strong>Account</strong></a>
                </div>
                ...
                <form method="post" action="seller-dashboard-account-edit.php">
                        <div class="d-flex float-start flex-row justify-content-end align-items-xl-start">
                            <a <button class="btn btn-primary d-xl-flex justify-content-xl-center align-items-xl-center" type="" style="width: 200px;height: 40px;margin-top: 5px;margin-bottom: 5px;font-size: 16px;background: #2d3693;border-width: 2px;border-color: #2d3693;color: #ffffff;padding-top: 12px;padding-bottom: 12px;text-align: center;" href="seller-dashboard-account-editmain.php">Edit Business Details</button></a>
                        </div>
