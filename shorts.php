...
<head>
    ...
    <title>Midnights Classic Thin Shorts - Tiangge Inc.</title>
...
<nav class="navbar navbar-light navbar-expand-md py-3" style="font-size: 18px;font-family: Poppins, sans-serif;">
    ...
    <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="assets/img/shorts/main.jpg" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="assets/img/shorts/main.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/shorts/1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/shorts/2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/shorts/3.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    <p>Home/Men</p>
                    <h1>Midnights Classic Thin Shorts</h1>
                    <h4>Php 99.00</h4>
                    <select>
                    ...
                    <br>
                    <p>These shorts are made from lightweight, breathable fabric that keeps you cool and relaxed, making them perfect 
                        for warm weather. The classic design features a tailored fit and a versatile length, ideal for both casual outings 
                        and lounging at home. With their sleek appearance and exceptional comfort, the Midnights Classic Thin Shorts 
