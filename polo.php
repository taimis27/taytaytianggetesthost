...
<head>
    ...
    <title>Summer Breeze Polo With Design Navy Blue - Tiangge Inc.</title>
...
<nav class="navbar navbar-light navbar-expand-md py-3" style="font-size: 18px;font-family: Poppins, sans-serif;">
    ...
    <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="assets/img/polo/main.png" width="100%" id="product-img">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="assets/img/polo/main.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/polo/1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/polo/2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/polo/3.jpg" width="100%" class="small-img">
                    </div>
                </div>
                ...
                <div class="col-2">
                    <p>Home/Men</p>
                    <h1>Summer Breeze Polo With Design Navy Blue</h1>
                    <h4>Php 149.00</h4>
                    <select>
                    ...
                    <br>
                    <p>Made from high-quality, breathable cotton, this polo ensures comfort even on the warmest days. 
                        The stylish design features bold patterns that add a touch of sophistication to the classic navy blue color. 
                        With its versatile look, the Summer Breeze Polo is ideal for both casual and semi-formal occasions.
                    </p>
                </div>
            </div>
        </div>
